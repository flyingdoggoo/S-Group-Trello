...
export const CardTodoUpsertArgsSchema: z.ZodType<Prisma.CardTodoUpsertArgs> = z.object({
  select: CardTodoSelectSchema.optional(),
  include: z.lazy(() => CardTodoIncludeSchema).optional(),
  where: CardTodoWhereUniqueInputSchema, 
  create: z.union([ CardTodoCreateInputSchema, CardTodoUncheckedCreateInputSchema ]),
  update: z.union([ CardTodoUpdateInputSchema, CardTodoUncheckedUpdateInputSchema ]),
}).strict();

export default CardTodoUpsertArgsSchema;
