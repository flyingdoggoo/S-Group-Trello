...
export const CardCommentUpdateArgsSchema: z.ZodType<Prisma.CardCommentUpdateArgs> = z.object({
  select: CardCommentSelectSchema.optional(),
  include: z.lazy(() => CardCommentIncludeSchema).optional(),
  data: z.union([ CardCommentUpdateInputSchema, CardCommentUncheckedUpdateInputSchema ]),
  where: CardCommentWhereUniqueInputSchema, 
}).strict();

export default CardCommentUpdateArgsSchema;
