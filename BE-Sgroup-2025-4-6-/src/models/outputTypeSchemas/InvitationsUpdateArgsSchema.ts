...
export const InvitationsUpdateArgsSchema: z.ZodType<Prisma.InvitationsUpdateArgs> = z.object({
  select: InvitationsSelectSchema.optional(),
  include: z.lazy(() => InvitationsIncludeSchema).optional(),
  data: z.union([ InvitationsUpdateInputSchema, InvitationsUncheckedUpdateInputSchema ]),
  where: InvitationsWhereUniqueInputSchema, 
}).strict();

export default InvitationsUpdateArgsSchema;
