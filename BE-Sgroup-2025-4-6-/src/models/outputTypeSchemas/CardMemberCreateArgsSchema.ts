...
export const CardMemberCreateArgsSchema: z.ZodType<Prisma.CardMemberCreateArgs> = z.object({
  select: CardMemberSelectSchema.optional(),
  include: z.lazy(() => CardMemberIncludeSchema).optional(),
  data: z.union([ CardMemberCreateInputSchema, CardMemberUncheckedCreateInputSchema ]),
}).strict();

export default CardMemberCreateArgsSchema;
