...
export const tokensUpdateManyAndReturnArgsSchema: z.ZodType<Prisma.tokensUpdateManyAndReturnArgs> = z.object({
...
export default tokensUpdateManyAndReturnArgsSchema;
