...
export const otpsCreateArgsSchema: z.ZodType<Prisma.otpsCreateArgs> = z.object({
  select: otpsSelectSchema.optional(),
  include: z.lazy(() => otpsIncludeSchema).optional(),
  data: z.union([ otpsCreateInputSchema, otpsUncheckedCreateInputSchema ]),
}).strict();

export default otpsCreateArgsSchema;
