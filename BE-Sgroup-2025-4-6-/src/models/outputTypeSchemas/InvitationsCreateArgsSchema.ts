...
export const InvitationsCreateArgsSchema: z.ZodType<Prisma.InvitationsCreateArgs> = z.object({
  select: InvitationsSelectSchema.optional(),
  include: z.lazy(() => InvitationsIncludeSchema).optional(),
  data: z.union([ InvitationsCreateInputSchema, InvitationsUncheckedCreateInputSchema ]),
}).strict();

export default InvitationsCreateArgsSchema;
