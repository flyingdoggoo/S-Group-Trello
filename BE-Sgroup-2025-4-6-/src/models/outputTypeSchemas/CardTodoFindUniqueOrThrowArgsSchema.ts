...
export const CardTodoFindUniqueOrThrowArgsSchema: z.ZodType<Prisma.CardTodoFindUniqueOrThrowArgs> = z.object({
  select: CardTodoSelectSchema.optional(),
  include: z.lazy(() => CardTodoIncludeSchema).optional(),
  where: CardTodoWhereUniqueInputSchema, 
}).strict();

export default CardTodoFindUniqueOrThrowArgsSchema;
