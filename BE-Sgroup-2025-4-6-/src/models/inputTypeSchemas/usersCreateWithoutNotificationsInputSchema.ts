...
export const usersCreateWithoutNotificationsInputSchema: z.ZodType<Prisma.usersCreateWithoutNotificationsInput> = z.strictObject({
  id: z.uuid().optional(),
  email: z.string(),
...
export default usersCreateWithoutNotificationsInputSchema;
