...
import { NestedEnumProjectStatusEnumWithAggregatesFilterSchema } from './NestedEnumProjectStatusEnumWithAggregatesFilterSchema';
import { NestedIntFilterSchema } from './NestedIntFilterSchema';
import { NestedEnumProjectStatusEnumFilterSchema } from './NestedEnumProjectStatusEnumFilterSchema';

export const EnumProjectStatusEnumWithAggregatesFilterSchema: z.ZodType<Prisma.EnumProjectStatusEnumWithAggregatesFilter> = z.strictObject({
...
export default EnumProjectStatusEnumWithAggregatesFilterSchema;
