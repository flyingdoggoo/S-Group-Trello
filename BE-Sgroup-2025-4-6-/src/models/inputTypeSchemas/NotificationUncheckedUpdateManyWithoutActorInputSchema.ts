...
export const NotificationUncheckedUpdateManyWithoutActorInputSchema: z.ZodType<Prisma.NotificationUncheckedUpdateManyWithoutActorInput> = z.strictObject({
...
export default NotificationUncheckedUpdateManyWithoutActorInputSchema;
