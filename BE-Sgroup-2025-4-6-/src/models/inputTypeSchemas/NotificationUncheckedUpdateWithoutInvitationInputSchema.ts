...
export const NotificationUncheckedUpdateWithoutInvitationInputSchema: z.ZodType<Prisma.NotificationUncheckedUpdateWithoutInvitationInput> = z.strictObject({
...
export default NotificationUncheckedUpdateWithoutInvitationInputSchema;
