...
import { NotificationCreateNestedManyWithoutActorInputSchema } from './NotificationCreateNestedManyWithoutActorInputSchema';

export const usersCreateWithoutSocialAccountsInputSchema: z.ZodType<Prisma.usersCreateWithoutSocialAccountsInput> = z.strictObject({
  id: z.uuid().optional(),
  email: z.string(),
  ...
  actions: z.lazy(() => NotificationCreateNestedManyWithoutActorInputSchema).optional(),
});

export default usersCreateWithoutSocialAccountsInputSchema;
