...
export const CardCommentCreateNestedManyWithoutUserInputSchema: z.ZodType<Prisma.CardCommentCreateNestedManyWithoutUserInput> = z.strictObject({
...
export default CardCommentCreateNestedManyWithoutUserInputSchema;
