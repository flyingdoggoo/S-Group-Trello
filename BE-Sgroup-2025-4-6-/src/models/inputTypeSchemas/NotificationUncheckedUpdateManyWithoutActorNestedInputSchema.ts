...
export const NotificationUncheckedUpdateManyWithoutActorNestedInputSchema: z.ZodType<Prisma.NotificationUncheckedUpdateManyWithoutActorNestedInput> = z.strictObject({
...
export default NotificationUncheckedUpdateManyWithoutActorNestedInputSchema;
