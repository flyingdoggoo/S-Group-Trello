...
export const projectUpdateWithoutBoardInputSchema: z.ZodType<Prisma.projectUpdateWithoutBoardInput> = z.strictObject({
...
export default projectUpdateWithoutBoardInputSchema;
