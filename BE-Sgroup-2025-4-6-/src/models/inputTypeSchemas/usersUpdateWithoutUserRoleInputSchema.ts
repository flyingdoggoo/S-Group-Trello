...
export const usersUpdateWithoutUserRoleInputSchema: z.ZodType<Prisma.usersUpdateWithoutUserRoleInput> = z.strictObject({
...
export default usersUpdateWithoutUserRoleInputSchema;
