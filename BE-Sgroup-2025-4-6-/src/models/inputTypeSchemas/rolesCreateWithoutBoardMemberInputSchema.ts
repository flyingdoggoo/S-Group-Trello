...
export const rolesCreateWithoutBoardMemberInputSchema: z.ZodType<Prisma.rolesCreateWithoutBoardMemberInput> = z.strictObject({
  id: z.uuid().optional(),
  roleName: z.string(),
...
export default rolesCreateWithoutBoardMemberInputSchema;
