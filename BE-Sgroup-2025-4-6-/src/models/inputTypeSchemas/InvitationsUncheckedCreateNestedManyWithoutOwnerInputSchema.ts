...
export const InvitationsUncheckedCreateNestedManyWithoutOwnerInputSchema: z.ZodType<Prisma.InvitationsUncheckedCreateNestedManyWithoutOwnerInput> = z.strictObject({
...
export default InvitationsUncheckedCreateNestedManyWithoutOwnerInputSchema;
