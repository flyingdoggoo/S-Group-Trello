...
export const CardMemberUncheckedCreateNestedManyWithoutUserInputSchema: z.ZodType<Prisma.CardMemberUncheckedCreateNestedManyWithoutUserInput> = z.strictObject({
...
export default CardMemberUncheckedCreateNestedManyWithoutUserInputSchema;
