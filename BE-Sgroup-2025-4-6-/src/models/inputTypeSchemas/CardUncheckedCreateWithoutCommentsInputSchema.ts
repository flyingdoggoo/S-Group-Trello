...
export const CardUncheckedCreateWithoutCommentsInputSchema: z.ZodType<Prisma.CardUncheckedCreateWithoutCommentsInput> = z.strictObject({
  id: z.uuid().optional(),
  listId: z.string(),
  title: z.string(),
...
export default CardUncheckedCreateWithoutCommentsInputSchema;
