...
export const InvitationsCreateManyProjectInputSchema: z.ZodType<Prisma.InvitationsCreateManyProjectInput> = z.strictObject({
  id: z.uuid().optional(),
...
export default InvitationsCreateManyProjectInputSchema;
