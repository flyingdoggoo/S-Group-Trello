...
export const InvitationsUpdateManyMutationInputSchema: z.ZodType<Prisma.InvitationsUpdateManyMutationInput> = z.strictObject({
...
export default InvitationsUpdateManyMutationInputSchema;
