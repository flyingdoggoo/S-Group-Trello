...
export const usersUncheckedUpdateWithoutAccountsInputSchema: z.ZodType<Prisma.usersUncheckedUpdateWithoutAccountsInput> = z.strictObject({
...
export default usersUncheckedUpdateWithoutAccountsInputSchema;
