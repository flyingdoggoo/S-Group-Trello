...
export const CardUncheckedUpdateWithoutMembersInputSchema: z.ZodType<Prisma.CardUncheckedUpdateWithoutMembersInput> = z.strictObject({
...
export default CardUncheckedUpdateWithoutMembersInputSchema;
