...
export const InvitationsUncheckedUpdateManyInputSchema: z.ZodType<Prisma.InvitationsUncheckedUpdateManyInput> = z.strictObject({
...
export default InvitationsUncheckedUpdateManyInputSchema;
