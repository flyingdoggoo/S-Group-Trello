...
export const BoardMemberUncheckedCreateNestedManyWithoutUserInputSchema: z.ZodType<Prisma.BoardMemberUncheckedCreateNestedManyWithoutUserInput> = z.strictObject({
...
export default BoardMemberUncheckedCreateNestedManyWithoutUserInputSchema;
