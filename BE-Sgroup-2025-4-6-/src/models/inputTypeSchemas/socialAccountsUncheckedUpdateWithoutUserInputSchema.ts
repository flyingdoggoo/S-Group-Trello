...
export const socialAccountsUncheckedUpdateWithoutUserInputSchema: z.ZodType<Prisma.socialAccountsUncheckedUpdateWithoutUserInput> = z.strictObject({
...
export default socialAccountsUncheckedUpdateWithoutUserInputSchema;
