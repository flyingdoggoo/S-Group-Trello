...
export const projectCreateWithoutInvitationInputSchema: z.ZodType<Prisma.projectCreateWithoutInvitationInput> = z.strictObject({
  id: z.uuid().optional(),
  title: z.string(),
...
export default projectCreateWithoutInvitationInputSchema;
