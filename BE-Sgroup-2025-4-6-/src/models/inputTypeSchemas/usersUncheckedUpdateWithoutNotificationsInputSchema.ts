...
export const usersUncheckedUpdateWithoutNotificationsInputSchema: z.ZodType<Prisma.usersUncheckedUpdateWithoutNotificationsInput> = z.strictObject({
...
export default usersUncheckedUpdateWithoutNotificationsInputSchema;
