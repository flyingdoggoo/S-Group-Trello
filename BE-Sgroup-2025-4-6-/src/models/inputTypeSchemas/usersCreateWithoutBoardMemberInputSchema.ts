...
export const usersCreateWithoutBoardMemberInputSchema: z.ZodType<Prisma.usersCreateWithoutBoardMemberInput> = z.strictObject({
  id: z.uuid().optional(),
  email: z.string(),
...
export default usersCreateWithoutBoardMemberInputSchema;
