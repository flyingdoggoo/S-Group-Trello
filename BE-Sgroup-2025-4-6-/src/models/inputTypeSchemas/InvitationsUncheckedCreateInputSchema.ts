...
export const InvitationsUncheckedCreateInputSchema: z.ZodType<Prisma.InvitationsUncheckedCreateInput> = z.strictObject({
  id: z.uuid().optional(),
...
export default InvitationsUncheckedCreateInputSchema;
