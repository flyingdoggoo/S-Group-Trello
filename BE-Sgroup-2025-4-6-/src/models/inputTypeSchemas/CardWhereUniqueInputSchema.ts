...
import { CardTagListRelationFilterSchema } from './CardTagListRelationFilterSchema';
import { CardTodoListRelationFilterSchema } from './CardTodoListRelationFilterSchema';
...
.and(z.strictObject({
  ...
  tags: z.lazy(() => CardTagListRelationFilterSchema).optional(),
  todos: z.lazy(() => CardTodoListRelationFilterSchema).optional(),
  members: z.lazy(() => CardMemberListRelationFilterSchema).optional(),
  comments: z.lazy(() => CardCommentListRelationFilterSchema).optional(),
}));
