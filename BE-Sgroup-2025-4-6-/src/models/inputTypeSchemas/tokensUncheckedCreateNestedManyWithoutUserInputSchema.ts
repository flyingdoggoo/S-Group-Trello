...
export const tokensUncheckedCreateNestedManyWithoutUserInputSchema: z.ZodType<Prisma.tokensUncheckedCreateNestedManyWithoutUserInput> = z.strictObject({
...
export default tokensUncheckedCreateNestedManyWithoutUserInputSchema;
