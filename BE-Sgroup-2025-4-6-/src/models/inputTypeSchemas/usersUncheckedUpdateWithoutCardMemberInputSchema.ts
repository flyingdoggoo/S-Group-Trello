...
export const usersUncheckedUpdateWithoutCardMemberInputSchema: z.ZodType<Prisma.usersUncheckedUpdateWithoutCardMemberInput> = z.strictObject({
...
export default usersUncheckedUpdateWithoutCardMemberInputSchema;
