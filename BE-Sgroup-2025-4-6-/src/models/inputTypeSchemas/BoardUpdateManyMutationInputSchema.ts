...
export const BoardUpdateManyMutationInputSchema: z.ZodType<Prisma.BoardUpdateManyMutationInput> = z.strictObject({
...
export default BoardUpdateManyMutationInputSchema;
