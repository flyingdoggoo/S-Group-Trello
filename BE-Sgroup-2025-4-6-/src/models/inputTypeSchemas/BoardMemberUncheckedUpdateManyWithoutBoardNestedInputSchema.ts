...
export const BoardMemberUncheckedUpdateManyWithoutBoardNestedInputSchema: z.ZodType<Prisma.BoardMemberUncheckedUpdateManyWithoutBoardNestedInput> = z.strictObject({
...
export default BoardMemberUncheckedUpdateManyWithoutBoardNestedInputSchema;
