...
export const BoardUncheckedUpdateManyInputSchema: z.ZodType<Prisma.BoardUncheckedUpdateManyInput> = z.strictObject({
...
export default BoardUncheckedUpdateManyInputSchema;
