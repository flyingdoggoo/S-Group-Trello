...
export const InvitationsUncheckedUpdateManyWithoutBoardInputSchema: z.ZodType<Prisma.InvitationsUncheckedUpdateManyWithoutBoardInput> = z.strictObject({
...
export default InvitationsUncheckedUpdateManyWithoutBoardInputSchema;
