...
export const ListUncheckedUpdateManyWithoutBoardInputSchema: z.ZodType<Prisma.ListUncheckedUpdateManyWithoutBoardInput> = z.strictObject({
...
export default ListUncheckedUpdateManyWithoutBoardInputSchema;
