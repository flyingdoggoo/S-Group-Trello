...
export const usersUncheckedUpdateWithoutActionsInputSchema: z.ZodType<Prisma.usersUncheckedUpdateWithoutActionsInput> = z.strictObject({
...
export default usersUncheckedUpdateWithoutActionsInputSchema;
