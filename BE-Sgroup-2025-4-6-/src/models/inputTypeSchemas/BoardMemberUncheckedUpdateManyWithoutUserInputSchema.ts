...
export const BoardMemberUncheckedUpdateManyWithoutUserInputSchema: z.ZodType<Prisma.BoardMemberUncheckedUpdateManyWithoutUserInput> = z.strictObject({
...
export default BoardMemberUncheckedUpdateManyWithoutUserInputSchema;
