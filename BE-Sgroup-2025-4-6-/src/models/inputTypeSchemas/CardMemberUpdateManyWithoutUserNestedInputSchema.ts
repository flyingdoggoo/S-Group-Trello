...
export const CardMemberUpdateManyWithoutUserNestedInputSchema: z.ZodType<Prisma.CardMemberUpdateManyWithoutUserNestedInput> = z.strictObject({
...
export default CardMemberUpdateManyWithoutUserNestedInputSchema;
