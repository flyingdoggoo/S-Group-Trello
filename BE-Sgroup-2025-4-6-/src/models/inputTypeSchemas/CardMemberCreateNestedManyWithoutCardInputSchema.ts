...
export const CardMemberCreateNestedManyWithoutCardInputSchema: z.ZodType<Prisma.CardMemberCreateNestedManyWithoutCardInput> = z.strictObject({
...
export default CardMemberCreateNestedManyWithoutCardInputSchema;
