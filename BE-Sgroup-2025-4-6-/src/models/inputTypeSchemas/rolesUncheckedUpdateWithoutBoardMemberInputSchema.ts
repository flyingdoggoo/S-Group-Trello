...
export const rolesUncheckedUpdateWithoutBoardMemberInputSchema: z.ZodType<Prisma.rolesUncheckedUpdateWithoutBoardMemberInput> = z.strictObject({
...
export default rolesUncheckedUpdateWithoutBoardMemberInputSchema;
