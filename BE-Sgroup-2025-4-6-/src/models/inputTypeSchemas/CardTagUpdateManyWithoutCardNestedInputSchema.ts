...
export const CardTagUpdateManyWithoutCardNestedInputSchema: z.ZodType<Prisma.CardTagUpdateManyWithoutCardNestedInput> = z.strictObject({
...
export default CardTagUpdateManyWithoutCardNestedInputSchema;
