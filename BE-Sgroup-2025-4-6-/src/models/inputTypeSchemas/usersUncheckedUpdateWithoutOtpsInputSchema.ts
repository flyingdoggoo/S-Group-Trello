...
export const usersUncheckedUpdateWithoutOtpsInputSchema: z.ZodType<Prisma.usersUncheckedUpdateWithoutOtpsInput> = z.strictObject({
...
export default usersUncheckedUpdateWithoutOtpsInputSchema;
