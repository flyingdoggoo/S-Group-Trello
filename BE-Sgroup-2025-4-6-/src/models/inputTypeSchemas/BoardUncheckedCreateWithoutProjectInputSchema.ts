...
export const BoardUncheckedCreateWithoutProjectInputSchema: z.ZodType<Prisma.BoardUncheckedCreateWithoutProjectInput> = z.strictObject({
  id: z.uuid().optional(),
  title: z.string(),
...
export default BoardUncheckedCreateWithoutProjectInputSchema;
