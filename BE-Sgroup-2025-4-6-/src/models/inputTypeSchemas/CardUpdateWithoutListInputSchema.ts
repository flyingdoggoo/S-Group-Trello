...
export const CardUpdateWithoutListInputSchema: z.ZodType<Prisma.CardUpdateWithoutListInput> = z.strictObject({
...
export default CardUpdateWithoutListInputSchema;
