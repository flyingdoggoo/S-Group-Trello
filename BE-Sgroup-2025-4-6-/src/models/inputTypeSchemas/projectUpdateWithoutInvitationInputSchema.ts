...
export const projectUpdateWithoutInvitationInputSchema: z.ZodType<Prisma.projectUpdateWithoutInvitationInput> = z.strictObject({
...
export default projectUpdateWithoutInvitationInputSchema;
