...
export const CardUpdateManyWithoutListNestedInputSchema: z.ZodType<Prisma.CardUpdateManyWithoutListNestedInput> = z.strictObject({
...
export default CardUpdateManyWithoutListNestedInputSchema;
