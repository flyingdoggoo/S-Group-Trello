...
export const InvitationsCreateManyInputSchema: z.ZodType<Prisma.InvitationsCreateManyInput> = z.strictObject({
  id: z.uuid().optional(),
...
export default InvitationsCreateManyInputSchema;
