...
export const InvitationsUncheckedUpdateManyWithoutOwnerNestedInputSchema: z.ZodType<Prisma.InvitationsUncheckedUpdateManyWithoutOwnerNestedInput> = z.strictObject({
...
export default InvitationsUncheckedUpdateManyWithoutOwnerNestedInputSchema;
