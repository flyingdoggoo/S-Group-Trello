...
export const tokensUpdateManyWithoutUserNestedInputSchema: z.ZodType<Prisma.tokensUpdateManyWithoutUserNestedInput> = z.strictObject({
...
export default tokensUpdateManyWithoutUserNestedInputSchema;
