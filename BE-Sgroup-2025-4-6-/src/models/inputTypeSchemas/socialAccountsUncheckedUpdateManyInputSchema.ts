...
export const socialAccountsUncheckedUpdateManyInputSchema: z.ZodType<Prisma.socialAccountsUncheckedUpdateManyInput> = z.strictObject({
...
export default socialAccountsUncheckedUpdateManyInputSchema;
