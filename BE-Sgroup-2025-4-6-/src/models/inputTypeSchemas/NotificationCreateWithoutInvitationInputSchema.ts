...
export const NotificationCreateWithoutInvitationInputSchema: z.ZodType<Prisma.NotificationCreateWithoutInvitationInput> = z.strictObject({
  id: z.uuid().optional(),
...
export default NotificationCreateWithoutInvitationInputSchema;
