...
import { NotificationUncheckedCreateNestedManyWithoutActorInputSchema } from './NotificationUncheckedCreateNestedManyWithoutActorInputSchema';

export const usersUncheckedCreateWithoutNotificationsInputSchema: z.ZodType<Prisma.usersUncheckedCreateWithoutNotificationsInput> = z.strictObject({
  id: z.uuid().optional(),
  email: z.string(),
  ...
  actions: z.lazy(() => NotificationUncheckedCreateNestedManyWithoutActorInputSchema).optional(),
});

export default usersUncheckedCreateWithoutNotificationsInputSchema;
