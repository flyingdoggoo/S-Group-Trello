...
export const accountsUncheckedUpdateOneWithoutUserNestedInputSchema: z.ZodType<Prisma.accountsUncheckedUpdateOneWithoutUserNestedInput> = z.strictObject({
...
export default accountsUncheckedUpdateOneWithoutUserNestedInputSchema;
