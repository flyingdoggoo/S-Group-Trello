...
export const CardTagUncheckedCreateNestedManyWithoutCardInputSchema: z.ZodType<Prisma.CardTagUncheckedCreateNestedManyWithoutCardInput> = z.strictObject({
...
export default CardTagUncheckedCreateNestedManyWithoutCardInputSchema;
