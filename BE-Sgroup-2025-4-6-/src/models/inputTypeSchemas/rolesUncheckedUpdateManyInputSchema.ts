...
export const rolesUncheckedUpdateManyInputSchema: z.ZodType<Prisma.rolesUncheckedUpdateManyInput> = z.strictObject({
...
export default rolesUncheckedUpdateManyInputSchema;
