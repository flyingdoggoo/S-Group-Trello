...
export const InvitationsUncheckedUpdateManyWithoutOwnerInputSchema: z.ZodType<Prisma.InvitationsUncheckedUpdateManyWithoutOwnerInput> = z.strictObject({
...
export default InvitationsUncheckedUpdateManyWithoutOwnerInputSchema;
