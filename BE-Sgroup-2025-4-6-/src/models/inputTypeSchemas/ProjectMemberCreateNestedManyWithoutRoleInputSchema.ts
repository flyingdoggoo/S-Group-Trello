...
export const ProjectMemberCreateNestedManyWithoutRoleInputSchema: z.ZodType<Prisma.ProjectMemberCreateNestedManyWithoutRoleInput> = z.strictObject({
...
export default ProjectMemberCreateNestedManyWithoutRoleInputSchema;
