...
export const CardTagUncheckedUpdateInputSchema: z.ZodType<Prisma.CardTagUncheckedUpdateInput> = z.strictObject({
...
export default CardTagUncheckedUpdateInputSchema;
