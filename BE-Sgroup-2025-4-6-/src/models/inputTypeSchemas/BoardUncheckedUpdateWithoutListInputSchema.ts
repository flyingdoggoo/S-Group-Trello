...
export const BoardUncheckedUpdateWithoutListInputSchema: z.ZodType<Prisma.BoardUncheckedUpdateWithoutListInput> = z.strictObject({
...
export default BoardUncheckedUpdateWithoutListInputSchema;
