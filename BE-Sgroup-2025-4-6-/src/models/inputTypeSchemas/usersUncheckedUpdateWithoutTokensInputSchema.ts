...
export const usersUncheckedUpdateWithoutTokensInputSchema: z.ZodType<Prisma.usersUncheckedUpdateWithoutTokensInput> = z.strictObject({
...
export default usersUncheckedUpdateWithoutTokensInputSchema;
