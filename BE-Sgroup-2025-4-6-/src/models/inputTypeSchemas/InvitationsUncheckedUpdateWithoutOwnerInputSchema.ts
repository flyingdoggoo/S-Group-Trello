...
export const InvitationsUncheckedUpdateWithoutOwnerInputSchema: z.ZodType<Prisma.InvitationsUncheckedUpdateWithoutOwnerInput> = z.strictObject({
...
export default InvitationsUncheckedUpdateWithoutOwnerInputSchema;
