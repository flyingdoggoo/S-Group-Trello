...
export const usersUpdateWithoutProjectMembersInputSchema: z.ZodType<Prisma.usersUpdateWithoutProjectMembersInput> = z.strictObject({
...
export default usersUpdateWithoutProjectMembersInputSchema;
