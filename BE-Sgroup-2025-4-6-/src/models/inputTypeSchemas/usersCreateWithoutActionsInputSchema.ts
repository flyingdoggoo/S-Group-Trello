...
export const usersCreateWithoutActionsInputSchema: z.ZodType<Prisma.usersCreateWithoutActionsInput> = z.strictObject({
  id: z.uuid().optional(),
  email: z.string(),
...
export default usersCreateWithoutActionsInputSchema;
