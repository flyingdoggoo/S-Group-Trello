...
import { CardTodoUpdateManyWithoutCardNestedInputSchema } from './CardTodoUpdateManyWithoutCardNestedInputSchema';
import { CardMemberUpdateManyWithoutCardNestedInputSchema } from './CardMemberUpdateManyWithoutCardNestedInputSchema';

export const CardUpdateWithoutCommentsInputSchema: z.ZodType<Prisma.CardUpdateWithoutCommentsInput> = z.strictObject({
  ...
  todos: z.lazy(() => CardTodoUpdateManyWithoutCardNestedInputSchema).optional(),
  members: z.lazy(() => CardMemberUpdateManyWithoutCardNestedInputSchema).optional(),
});

export default CardUpdateWithoutCommentsInputSchema;
