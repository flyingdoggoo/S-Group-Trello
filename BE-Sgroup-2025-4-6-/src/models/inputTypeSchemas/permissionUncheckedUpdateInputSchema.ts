...
import { RolePermissionUncheckedUpdateManyWithoutPermissionNestedInputSchema } from './RolePermissionUncheckedUpdateManyWithoutPermissionNestedInputSchema';
...
export const permissionUncheckedUpdateInputSchema: z.ZodType<Prisma.permissionUncheckedUpdateInput> = z.strictObject({
  ...
  RolePermission: z.lazy(() => RolePermissionUncheckedUpdateManyWithoutPermissionNestedInputSchema).optional(),
});
