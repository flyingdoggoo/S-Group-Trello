...
export const usersUpdateWithoutNotificationsInputSchema: z.ZodType<Prisma.usersUpdateWithoutNotificationsInput> = z.strictObject({
...
export default usersUpdateWithoutNotificationsInputSchema;
