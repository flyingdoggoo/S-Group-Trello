...
export const CardCommentUpdateManyWithoutUserNestedInputSchema: z.ZodType<Prisma.CardCommentUpdateManyWithoutUserNestedInput> = z.strictObject({
...
export default CardCommentUpdateManyWithoutUserNestedInputSchema;
