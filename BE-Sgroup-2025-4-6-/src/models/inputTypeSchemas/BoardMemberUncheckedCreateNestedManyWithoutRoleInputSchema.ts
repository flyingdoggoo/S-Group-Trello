...
export const BoardMemberUncheckedCreateNestedManyWithoutRoleInputSchema: z.ZodType<Prisma.BoardMemberUncheckedCreateNestedManyWithoutRoleInput> = z.strictObject({
...
export default BoardMemberUncheckedCreateNestedManyWithoutRoleInputSchema;
