...
export const rolesUpdateWithoutRolePermissionInputSchema: z.ZodType<Prisma.rolesUpdateWithoutRolePermissionInput> = z.strictObject({
...
export default rolesUpdateWithoutRolePermissionInputSchema;
