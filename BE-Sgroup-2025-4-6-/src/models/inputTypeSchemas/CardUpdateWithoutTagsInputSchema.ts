...
export const CardUpdateWithoutTagsInputSchema: z.ZodType<Prisma.CardUpdateWithoutTagsInput> = z.strictObject({
...
export default CardUpdateWithoutTagsInputSchema;
