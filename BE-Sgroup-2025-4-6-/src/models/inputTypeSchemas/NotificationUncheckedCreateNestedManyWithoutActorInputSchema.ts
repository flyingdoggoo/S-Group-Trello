...
export const NotificationUncheckedCreateNestedManyWithoutActorInputSchema: z.ZodType<Prisma.NotificationUncheckedCreateNestedManyWithoutActorInput> = z.strictObject({
...
export default NotificationUncheckedCreateNestedManyWithoutActorInputSchema;
