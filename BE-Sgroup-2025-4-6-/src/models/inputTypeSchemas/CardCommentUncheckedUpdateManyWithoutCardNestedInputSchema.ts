...
export const CardCommentUncheckedUpdateManyWithoutCardNestedInputSchema: z.ZodType<Prisma.CardCommentUncheckedUpdateManyWithoutCardNestedInput> = z.strictObject({
...
export default CardCommentUncheckedUpdateManyWithoutCardNestedInputSchema;
