...
export const usersUncheckedCreateWithoutActionsInputSchema: z.ZodType<Prisma.usersUncheckedCreateWithoutActionsInput> = z.strictObject({
  id: z.uuid().optional(),
  email: z.string(),
...
export default usersUncheckedCreateWithoutActionsInputSchema;
