...
export const BoardUpdateManyWithoutProjectNestedInputSchema: z.ZodType<Prisma.BoardUpdateManyWithoutProjectNestedInput> = z.strictObject({
...
export default BoardUpdateManyWithoutProjectNestedInputSchema;
