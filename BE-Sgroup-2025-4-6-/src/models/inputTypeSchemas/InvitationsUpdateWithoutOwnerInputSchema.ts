...
export const InvitationsUpdateWithoutOwnerInputSchema: z.ZodType<Prisma.InvitationsUpdateWithoutOwnerInput> = z.strictObject({
...
export default InvitationsUpdateWithoutOwnerInputSchema;
