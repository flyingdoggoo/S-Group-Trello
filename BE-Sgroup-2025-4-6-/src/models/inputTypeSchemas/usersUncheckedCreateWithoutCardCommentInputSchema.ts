...
export const usersUncheckedCreateWithoutCardCommentInputSchema: z.ZodType<Prisma.usersUncheckedCreateWithoutCardCommentInput> = z.strictObject({
  id: z.uuid().optional(),
  email: z.string(),
...
export default usersUncheckedCreateWithoutCardCommentInputSchema;
