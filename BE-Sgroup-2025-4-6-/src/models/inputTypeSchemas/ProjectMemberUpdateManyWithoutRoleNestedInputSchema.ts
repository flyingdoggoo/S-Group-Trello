...
export const ProjectMemberUpdateManyWithoutRoleNestedInputSchema: z.ZodType<Prisma.ProjectMemberUpdateManyWithoutRoleNestedInput> = z.strictObject({
...
export default ProjectMemberUpdateManyWithoutRoleNestedInputSchema;
