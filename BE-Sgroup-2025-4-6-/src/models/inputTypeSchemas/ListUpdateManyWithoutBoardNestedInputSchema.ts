...
export const ListUpdateManyWithoutBoardNestedInputSchema: z.ZodType<Prisma.ListUpdateManyWithoutBoardNestedInput> = z.strictObject({
...
export default ListUpdateManyWithoutBoardNestedInputSchema;
