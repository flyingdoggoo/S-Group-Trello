...
export const usersCreateWithoutCardCommentInputSchema: z.ZodType<Prisma.usersCreateWithoutCardCommentInput> = z.strictObject({
  id: z.uuid().optional(),
  email: z.string(),
...
export default usersCreateWithoutCardCommentInputSchema;
