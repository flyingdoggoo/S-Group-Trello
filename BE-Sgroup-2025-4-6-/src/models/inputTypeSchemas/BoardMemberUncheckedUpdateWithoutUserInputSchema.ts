...
export const BoardMemberUncheckedUpdateWithoutUserInputSchema: z.ZodType<Prisma.BoardMemberUncheckedUpdateWithoutUserInput> = z.strictObject({
...
export default BoardMemberUncheckedUpdateWithoutUserInputSchema;
