...
export const CardUncheckedUpdateWithoutTagsInputSchema: z.ZodType<Prisma.CardUncheckedUpdateWithoutTagsInput> = z.strictObject({
...
export default CardUncheckedUpdateWithoutTagsInputSchema;
