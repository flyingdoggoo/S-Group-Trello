...
export const socialAccountsUncheckedUpdateOneWithoutUserNestedInputSchema: z.ZodType<Prisma.socialAccountsUncheckedUpdateOneWithoutUserNestedInput> = z.strictObject({
...
export default socialAccountsUncheckedUpdateOneWithoutUserNestedInputSchema;
