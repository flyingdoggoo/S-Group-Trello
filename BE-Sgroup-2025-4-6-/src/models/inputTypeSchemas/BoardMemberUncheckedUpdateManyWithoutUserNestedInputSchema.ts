...
export const BoardMemberUncheckedUpdateManyWithoutUserNestedInputSchema: z.ZodType<Prisma.BoardMemberUncheckedUpdateManyWithoutUserNestedInput> = z.strictObject({
...
export default BoardMemberUncheckedUpdateManyWithoutUserNestedInputSchema;
