...
export const otpsUncheckedUpdateOneWithoutUserNestedInputSchema: z.ZodType<Prisma.otpsUncheckedUpdateOneWithoutUserNestedInput> = z.strictObject({
...
export default otpsUncheckedUpdateOneWithoutUserNestedInputSchema;
