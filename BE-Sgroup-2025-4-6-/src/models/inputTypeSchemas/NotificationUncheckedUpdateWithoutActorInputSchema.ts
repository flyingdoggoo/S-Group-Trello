...
export const NotificationUncheckedUpdateWithoutActorInputSchema: z.ZodType<Prisma.NotificationUncheckedUpdateWithoutActorInput> = z.strictObject({
...
export default NotificationUncheckedUpdateWithoutActorInputSchema;
