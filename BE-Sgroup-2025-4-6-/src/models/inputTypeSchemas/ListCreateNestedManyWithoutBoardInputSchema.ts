...
export const ListCreateNestedManyWithoutBoardInputSchema: z.ZodType<Prisma.ListCreateNestedManyWithoutBoardInput> = z.strictObject({
...
export default ListCreateNestedManyWithoutBoardInputSchema;
