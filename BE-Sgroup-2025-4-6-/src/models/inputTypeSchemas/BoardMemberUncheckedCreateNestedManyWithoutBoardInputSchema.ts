...
export const BoardMemberUncheckedCreateNestedManyWithoutBoardInputSchema: z.ZodType<Prisma.BoardMemberUncheckedCreateNestedManyWithoutBoardInput> = z.strictObject({
...
export default BoardMemberUncheckedCreateNestedManyWithoutBoardInputSchema;
