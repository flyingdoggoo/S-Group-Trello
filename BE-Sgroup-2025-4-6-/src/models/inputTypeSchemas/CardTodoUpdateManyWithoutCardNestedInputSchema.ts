...
export const CardTodoUpdateManyWithoutCardNestedInputSchema: z.ZodType<Prisma.CardTodoUpdateManyWithoutCardNestedInput> = z.strictObject({
...
export default CardTodoUpdateManyWithoutCardNestedInputSchema;
