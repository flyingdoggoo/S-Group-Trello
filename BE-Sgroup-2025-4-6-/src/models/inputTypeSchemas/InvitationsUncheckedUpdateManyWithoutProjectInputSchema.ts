...
export const InvitationsUncheckedUpdateManyWithoutProjectInputSchema: z.ZodType<Prisma.InvitationsUncheckedUpdateManyWithoutProjectInput> = z.strictObject({
...
export default InvitationsUncheckedUpdateManyWithoutProjectInputSchema;
