...
export const CardMemberUpdateManyWithoutCardNestedInputSchema: z.ZodType<Prisma.CardMemberUpdateManyWithoutCardNestedInput> = z.strictObject({
...
export default CardMemberUpdateManyWithoutCardNestedInputSchema;
