...
export const usersUpdateWithoutActionsInputSchema: z.ZodType<Prisma.usersUpdateWithoutActionsInput> = z.strictObject({
...
export default usersUpdateWithoutActionsInputSchema;
