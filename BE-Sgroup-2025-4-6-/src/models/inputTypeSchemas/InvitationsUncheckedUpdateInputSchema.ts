...
export const InvitationsUncheckedUpdateInputSchema: z.ZodType<Prisma.InvitationsUncheckedUpdateInput> = z.strictObject({
...
export default InvitationsUncheckedUpdateInputSchema;
