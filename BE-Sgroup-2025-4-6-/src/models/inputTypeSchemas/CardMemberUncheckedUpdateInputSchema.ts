...
export const CardMemberUncheckedUpdateInputSchema: z.ZodType<Prisma.CardMemberUncheckedUpdateInput> = z.strictObject({
...
export default CardMemberUncheckedUpdateInputSchema;
