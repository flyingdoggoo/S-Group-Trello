...
export const BoardMemberUpdateManyWithoutRoleNestedInputSchema: z.ZodType<Prisma.BoardMemberUpdateManyWithoutRoleNestedInput> = z.strictObject({
...
export default BoardMemberUpdateManyWithoutRoleNestedInputSchema;
