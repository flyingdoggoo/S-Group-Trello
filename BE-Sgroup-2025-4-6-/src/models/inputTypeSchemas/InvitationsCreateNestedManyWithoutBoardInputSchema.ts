...
export const InvitationsCreateNestedManyWithoutBoardInputSchema: z.ZodType<Prisma.InvitationsCreateNestedManyWithoutBoardInput> = z.strictObject({
...
export default InvitationsCreateNestedManyWithoutBoardInputSchema;
