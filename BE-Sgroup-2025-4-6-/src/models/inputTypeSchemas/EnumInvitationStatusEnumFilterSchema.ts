...
export const EnumInvitationStatusEnumFilterSchema: z.ZodType<Prisma.EnumInvitationStatusEnumFilter> = z.strictObject({
...
export default EnumInvitationStatusEnumFilterSchema;
