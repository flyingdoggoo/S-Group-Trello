...
export const BoardUncheckedUpdateWithoutInvitationInputSchema: z.ZodType<Prisma.BoardUncheckedUpdateWithoutInvitationInput> = z.strictObject({
...
export default BoardUncheckedUpdateWithoutInvitationInputSchema;
