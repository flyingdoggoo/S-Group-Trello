...
export const CardUpdateWithoutMembersInputSchema: z.ZodType<Prisma.CardUpdateWithoutMembersInput> = z.strictObject({
...
export default CardUpdateWithoutMembersInputSchema;
