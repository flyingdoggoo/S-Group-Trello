...
export const InvitationsUncheckedUpdateManyWithoutBoardNestedInputSchema: z.ZodType<Prisma.InvitationsUncheckedUpdateManyWithoutBoardNestedInput> = z.strictObject({
...
export default InvitationsUncheckedUpdateManyWithoutBoardNestedInputSchema;
