...
export const CardUncheckedCreateWithoutMembersInputSchema: z.ZodType<Prisma.CardUncheckedCreateWithoutMembersInput> = z.strictObject({
  id: z.uuid().optional(),
  listId: z.string(),
  title: z.string(),
...
export default CardUncheckedCreateWithoutMembersInputSchema;
