...
export const rolesUpdateWithoutProjectMembersInputSchema: z.ZodType<Prisma.rolesUpdateWithoutProjectMembersInput> = z.strictObject({
...
export default rolesUpdateWithoutProjectMembersInputSchema;
