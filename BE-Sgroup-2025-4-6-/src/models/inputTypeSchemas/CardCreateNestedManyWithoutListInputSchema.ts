...
export const CardCreateNestedManyWithoutListInputSchema: z.ZodType<Prisma.CardCreateNestedManyWithoutListInput> = z.strictObject({
...
export default CardCreateNestedManyWithoutListInputSchema;
