...
export const usersCreateWithoutCardMemberInputSchema: z.ZodType<Prisma.usersCreateWithoutCardMemberInput> = z.strictObject({
  id: z.uuid().optional(),
  email: z.string(),
...
export default usersCreateWithoutCardMemberInputSchema;
