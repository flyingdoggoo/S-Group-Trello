...
export const BoardCreateWithoutInvitationInputSchema: z.ZodType<Prisma.BoardCreateWithoutInvitationInput> = z.strictObject({
  id: z.uuid().optional(),
  title: z.string(),
...
export default BoardCreateWithoutInvitationInputSchema;
