...
export const NotificationUncheckedUpdateManyWithoutInvitationInputSchema: z.ZodType<Prisma.NotificationUncheckedUpdateManyWithoutInvitationInput> = z.strictObject({
...
export default NotificationUncheckedUpdateManyWithoutInvitationInputSchema;
