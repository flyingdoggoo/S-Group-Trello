...
export const InvitationsUncheckedUpdateWithoutNotificationsInputSchema: z.ZodType<Prisma.InvitationsUncheckedUpdateWithoutNotificationsInput> = z.strictObject({
...
export default InvitationsUncheckedUpdateWithoutNotificationsInputSchema;
