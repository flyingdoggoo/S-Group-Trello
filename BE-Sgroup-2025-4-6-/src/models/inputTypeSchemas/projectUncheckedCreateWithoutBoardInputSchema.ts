...
export const projectUncheckedCreateWithoutBoardInputSchema: z.ZodType<Prisma.projectUncheckedCreateWithoutBoardInput> = z.strictObject({
  id: z.uuid().optional(),
  title: z.string(),
...
export default projectUncheckedCreateWithoutBoardInputSchema;
