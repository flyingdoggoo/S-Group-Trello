...
export const usersUpdateWithoutCardMemberInputSchema: z.ZodType<Prisma.usersUpdateWithoutCardMemberInput> = z.strictObject({
...
export default usersUpdateWithoutCardMemberInputSchema;
