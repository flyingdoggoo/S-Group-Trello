...
export const InvitationsCreateManyOwnerInputSchema: z.ZodType<Prisma.InvitationsCreateManyOwnerInput> = z.strictObject({
  id: z.uuid().optional(),
...
export default InvitationsCreateManyOwnerInputSchema;
