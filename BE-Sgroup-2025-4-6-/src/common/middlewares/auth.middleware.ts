...
import { ForbiddenException, OptionalException, UnauthorizedException } from "../exceptions";
        ...
        try {
            ...
            try {
                ...
                if (error instanceof TokenExpiredError) {
                    throw new OptionalException(StatusCodes.UNAUTHORIZED, 'Token has expired');
                }
