    ...
    >
      ...
      <div className="flex items-center justify-between px-4 py-3 border-b">
        {!collapsed && <h2 className="text-lg font-semibold flex items-center gap-2">
          <FontAwesomeIcon icon={faTrello} style={{color: "#1e5076"}} className="text-3xl" />
          Trello
          </h2>}
        <button
      ...
      <div className="flex-1 flex flex-col py-4 overflow-y-auto">
        ...
        {!collapsed && (
          <div className="px-4 mb-2">
            <h3 className="text-xs font-semibold text-gray-500 tracking-wider">Navigation</h3>
          </div>
        )}
        <div className="mb-4">
        ...
        {!collapsed && (
          <div className="px-4 mb-2">
            <h3 className="text-xs font-semibold text-gray-500 tracking-wider">Workspaces</h3>
          </div>
        )}
        <div>
